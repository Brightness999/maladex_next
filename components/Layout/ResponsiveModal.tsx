...
const ResponsiveModal = ({ show, theme, changeTheme, close }: Props) => {
  return (
    <div className={`${styles.modal} ${show ? styles.active : ''}`}>
      ...
      <div className={styles.modal_content}>
        <div className={styles.modal_content_connect}>
          <button onClick={close} className={styles.modal_content_wallet}>
            Connect Wallet
          </button>
          <div className={styles.modal__bgswitch}>
            <svg viewBox="0 0 24 24" color="backgroundAlt" width="30px" xmlns="http://www.w3.org/2000/svg" className={`${styles.navbar__bgswitch_day} ${theme == 'day' ? styles.navbar__bgswitch_day_active : ''}`} onClick={() => changeTheme('day')}>
            ...
            <svg viewBox="0 0 24 24" color="backgroundAlt" width="30px" xmlns="http://www.w3.org/2000/svg" className={`${styles.navbar__bgswitch_night} ${theme == 'night' ? styles.navbar__bgswitch_night_active : ''}`} onClick={() => changeTheme('night')}>
        ...
        <div className={styles.modal_content_types}>
          <div className={styles.modal_content_types_item} onClick={close}>
            <span>Trade</span>
          </div>
          <div className={styles.modal_content_types_item} onClick={close}>
            <span>Mint</span>
