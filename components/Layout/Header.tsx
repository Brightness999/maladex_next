      ...
      <div className={styles.navbar__container} >
        ...
        <div className={styles.navbar__container_launch}>
          ...
          <div className={styles.navbar__bgswitch}>
            <svg viewBox="0 0 24 24" color="backgroundAlt" width="30px" xmlns="http://www.w3.org/2000/svg" className={`${styles.navbar__bgswitch_day} ${theme == 'day' ? styles.navbar__bgswitch_day_active : ''}`} onClick={() => setTheme('day')}>
            ...
            <svg viewBox="0 0 24 24" color="backgroundAlt" width="30px" xmlns="http://www.w3.org/2000/svg" className={`${styles.navbar__bgswitch_night} ${theme == 'night' ? styles.navbar__bgswitch_night_active : ''}`} onClick={() => setTheme('night')}>
